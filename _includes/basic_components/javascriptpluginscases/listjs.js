...
var options = {
  valueNames: [{% for element in include.listjsData.filters %}{% if element.element == 'all' or element.element == 'none'%}{% else %}'{{ element.element | lstrip }}'{% unless forloop.last %},{% endunless %}{% endif %}{% endfor %} ]};
